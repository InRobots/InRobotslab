...
![]({{ site.url }}{{ site.baseurl }}/images/respic/light1.jpg){: style="width: 25%; float: middle; margin: 0px"}
![]({{ site.url }}{{ site.baseurl }}/images/respic/light2.jpg){: style="width: 25%; float: middle; margin: 0px"}
